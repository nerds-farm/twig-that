...
namespace TwigThat\Core\Managers;
...
final class Modules {
    ...
    public function __construct() {
        ...
        $modules = $this->find_modules(TWIG_THAT_PATH);
        $this->add_modules($modules);

        do_action('twig-that/modules');
    }
    ...
    public function add_modules($modules = array(), $domain = 'TwigThat') {
